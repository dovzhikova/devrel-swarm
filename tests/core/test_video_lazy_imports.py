...
class TestTTSEngineLazyImport:
    def test_require_openai_raises_helpful_error_when_missing(
        ...
        """
        from devrel_swarm.core.video import tts_engine
        ...
        with pytest.raises(ImportError, match=r"devrel-swarm\[video\]"):
...
class TestCoreImportsHaveNoVideoEagerLoad:
    @pytest.mark.parametrize(
        ...
        [
            "devrel_swarm",
            "devrel_swarm.core.atlas",
            "devrel_swarm.core.argus",
            "devrel_swarm.core.kai",
            "devrel_swarm.core.echo",
            "devrel_swarm.cli",
        ],
    )
